...
<body>
     <h1 style="text-align: center; background-color: #FFA07A;">Calificación de los alumnos del CBTis</h1>
     <h3 style="text-align: center; background-color: #FFA07A;">Descripcion</h3>
     <!-- <center> -->
     <p text-align: center;>
     ...
     <h3 style="text-align: center; background-color: #FFA07A;"> Resultados xd </h3>
     <!-- </center> -->
     <?php
            $cal=array();
            $x=rand(1,1000);
            ...
            echo "<table border='1' cellspacing='3' cellpadign='3';  border: #2618a5 3px solid; font-style: italic;text-align: center;'>";
            for($i=0; $i<$x; $i++)
            {
                if($i%30==0)
                {
                ...
                {
                    echo "<th  style='text-align: left; background-color: #FFA07A;'>". $cal[$i]. "</th>";
                }
            }
            echo "</tr>";
            echo "</table>";
